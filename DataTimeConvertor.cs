...
namespace Converter
{
    class DataTimeConvertor : IMultiValueConverter
    {
        ...
        {
            incomeDataTime = (DateTime)value;
            return new object[] { incomeDataTime.Day, incomeDataTime.Month, incomeDataTime.Year };
        }
    }
}
